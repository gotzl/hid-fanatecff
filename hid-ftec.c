...
#define CSL_ELITE_WHEELBASE_CLUBSPORT_V25_DEVICE_ID 0x0004
...
static const struct hid_device_id devices[] = {
	...
	{ HID_USB_DEVICE(FANATEC_VENDOR_ID, CSL_ELITE_WHEELBASE_CLUBSPORT_V25_DEVICE_ID), .driver_data = FTEC_FF | FTEC_LEDS},
